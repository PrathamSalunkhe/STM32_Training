...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
#define MAX_SIZE 10			//macro for size of buffer
...
/* USER CODE BEGIN PV */
uint8_t rx_buffer[10];		//rx buffer
uint8_t print_buffer[10];	//buffer to print data on terminal
uint16_t Index = 0;			//index for buffer
/* USER CODE END PV */
