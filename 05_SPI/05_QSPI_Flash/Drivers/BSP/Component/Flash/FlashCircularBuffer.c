...
fcb_status EraseFlashSector(flash_circular_buffer* buffer,uint32_t sector_addr)
{
 ...
 switch(buffer->tail)
 {
   case ((BLOCK1_ADDR - ((QSPI_BLOCK_SIZE_64K * 1) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK2_ADDR - ((QSPI_BLOCK_SIZE_64K * 2) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK3_ADDR - ((QSPI_BLOCK_SIZE_64K * 3) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK4_ADDR - ((QSPI_BLOCK_SIZE_64K * 4) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK5_ADDR - ((QSPI_BLOCK_SIZE_64K * 5) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK6_ADDR - ((QSPI_BLOCK_SIZE_64K * 6) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK7_ADDR - ((QSPI_BLOCK_SIZE_64K * 7) % sizeof(data_info)) + sizeof(data_info))):

   case ((BLOCK8_ADDR - ((QSPI_BLOCK_SIZE_64K * 8) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK9_ADDR - ((QSPI_BLOCK_SIZE_64K * 9) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK10_ADDR - ((QSPI_BLOCK_SIZE_64K * 10) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK11_ADDR - ((QSPI_BLOCK_SIZE_64K * 11) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK12_ADDR - ((QSPI_BLOCK_SIZE_64K * 12) % sizeof(data_info)) + sizeof(data_info))):
   case ((BLOCK13_ADDR - ((QSPI_BLOCK_SIZE_64K * 13) % sizeof(data_info)) + sizeof(data_info))):
