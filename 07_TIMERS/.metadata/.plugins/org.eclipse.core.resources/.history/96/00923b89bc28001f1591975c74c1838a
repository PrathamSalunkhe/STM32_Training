...
{
	/* Enter the reload value into SysTick reload value register */
    SysTick->LOAD = (16000 - 1); // 16MHz / 1000 = 16000 (for 1ms delay)
    /*
     System Clock is 16 MHz
     16000000 cycle in 1 second
     1 sec = 1000 ms
     so, 1 ms = 16000000 /1000
     1 ms = 16000
     */
...
void DelayMs(uint32_t Delay)
{
    ...
    {
        // Wait until the COUNTFLAG is set (bit 16)
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  DelayMs(1000);	//delay for 1000ms = 1s
  }
  /* USER CODE END 3 */
}
